...
def ocr(i):
    ...
    date = th[375:420, 440:510]
    cv2.imshow("date", date)

    month = th[375:420, 500:655]
    ...
    print('Date of Birth: '+ str(text5[:-1])+ ' ' + str(text6[:-1]))
    ...
    return '''
            ...
            <body>
                ...
                <form>
                    ...
                    <input type="text" id="lname" name="lname" value="''' + text7 + '''"><br><br>
                    <label for="lname">Gender:</label><br>
                    <input type="text" id="lname" name="lname" value="''' + text8 + '''"><br><br>
                </form>
            </body>'''
